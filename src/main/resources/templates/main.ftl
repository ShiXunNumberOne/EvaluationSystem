        ...
        <#--<table class="layui-table" lay-skin="line">-->
            ...
            <#--<tbody class="hot_news">-->
                <#--<@myindex limit = "5">-->
                    ...
                    <#--</#if>-->
                <#--</@myindex>-->
                <#--&lt;#&ndash;<@ar channelId = "5">&ndash;&gt;-->
                    <#--&lt;#&ndash;<#assign articleList = result["articleList"]>&ndash;&gt;-->
                    <#--&lt;#&ndash;<#if (articleList?size>0)>&ndash;&gt;-->
                        <#--&lt;#&ndash;<#list articleList as items>&ndash;&gt;-->
                                <#--&lt;#&ndash;<tr><td align="left">${items.title}</td><td>${items.publistTime?string("yyyy-MM-dd")}</td></tr>&ndash;&gt;-->
                        <#--&lt;#&ndash;</#list>&ndash;&gt;-->
                    <#--&lt;#&ndash;</#if>&ndash;&gt;-->
                <#--&lt;#&ndash;</@ar>&ndash;&gt;-->
            <#--</tbody>-->
