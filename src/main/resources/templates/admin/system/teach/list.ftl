...
<fieldset class="layui-elem-field">
    ...
    <form class="layui-form">
        ...
        <div class="layui-inline">
            <a class="layui-btn layui-btn-normal" data-type="addClazz">添加授课</a>
        </div>
        <div class="layui-inline">
...
<script>
    layui.use(['layer','form','table'], function() {
        ...
        t = {
            elem: '#test',
            url:'${base}/admin/system/teach/list',
            method:'post',
            ...
            cols: [[
                ...
                {field:'ccode',  title: '课程代码'},
                {field:'name', title: '班级名称'},
                {field:'code', title: '班级代码'},
                {field:'uname', title: '教师名称'},
        ...
        table.on('tool(demo)', function(obj){
            ...
            if(obj.event === 'edit'){
                var editIndex = layer.open({
                    title : "编辑用户",
                    type : 2,
                    content : "${base}/admin/system/teach/edit?id="+data.id,
            ...
            if(obj.event === "del"){
                layer.confirm("你确定要删除该用户么？",{btn:['是的,我确定','我再想想']},
                    function(){
                        $.post("${base}/admin/system/teach/delete",{"id":data.id},function (res){
                           if(res.success){
        ...
        var active={
            addClazz : function(){
                var addIndex = layer.open({
                    title : "添加会员",
                    type : 2,
                    content : "${base}/admin/system/teach/add",
